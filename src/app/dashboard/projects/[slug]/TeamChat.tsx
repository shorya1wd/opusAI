  ...
  return (
    <div className="flex flex-col h-full bg-neutral-50/50 dark:bg-neutral-900/30">
      ...
      <div className="p-4 bg-white/50 dark:bg-neutral-950/50 backdrop-blur-md border-t">
        <form onSubmit={handleSend} className="relative max-w-4xl mx-auto flex items-center gap-2 bg-white dark:bg-neutral-950 border shadow-sm rounded-xl overflow-hidden focus-within:ring-1 focus-within:ring-blue-500/50 transition-all p-1.5">
          <Input 
            value={content}
